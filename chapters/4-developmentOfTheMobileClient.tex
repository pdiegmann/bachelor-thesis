...
\\
Because time was still a matter to us, we decided to include as much as possible from the web application and copy and modify as less as possible. During further development, when the web application is upgraded to Vaadin 7, both projects can be merged together and code redundancies can be removed.
\\
\\
